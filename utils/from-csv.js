 ...
 * Первая строка CSV используется как названия свойств объектов.
 * Поддерживает значения в кавычках, экранированные двойные кавычки
 * и переносы строк внутри кавычек.
 * 
